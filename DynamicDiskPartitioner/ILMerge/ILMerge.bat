...
%ilmergePath%\ilmerge /ndebug /target:winexe /out:"%outputPath%\DynamicDiskPartitioner.exe" "%binaryPath%\DynamicDiskPartitioner.exe" "%binaryPath%\Utilities.dll" "%binaryPath%\DiskAccessLibrary.dll"