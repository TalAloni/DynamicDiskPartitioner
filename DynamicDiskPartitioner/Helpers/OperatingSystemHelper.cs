...
namespace DynamicDiskPartitioner
{
    public class OperatingSystemHelper
    {
        public static string GetUpdateMessage()
        {
            ...
            builder.AppendLine("To re-enable the disk group, you must do one of the following:");
            builder.AppendLine("- Restart your computer (RECOMMENDED)");
            builder.AppendLine("- Go to Disk Management and reactivate the disk group (NOT RECOMMENDED*)");
            builder.AppendLine();
            builder.AppendLine("* When reactivation is performed without restart, the on-disk update log will");
            builder.AppendLine("  be overwritten by old entries. This may cause a problem if the log will be");
            builder.AppendLine("  needed for recovery purposes.");
            ...
            builder.AppendLine();
            builder.AppendLine("WARNING: You must not use the volumes until performing one of these steps.");
